...
int main (void)
{
  ...
  for (;;)
  {
    ...
    LCDdrawstring(10, 2, "OpenRoboHUS");
    LCDdrawline(0, 10, 84, 10, BLACK);
    LCDdrawstring(3, 12, uptimeInfo);
    LCDdrawstring(3, 20, cpuInfo);
    LCDdrawstring(3, 28, ramInfo);
    LCDdrawstring(3, 36, cputemperature);
    LCDdrawrect(0, 0, 84, 48, BLACK);
    LCDdrawrect(1, 1, 82, 46, WHITE);
