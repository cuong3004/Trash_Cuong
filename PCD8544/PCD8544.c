...
// LCD port variables
static uint8_t cursor_x, cursor_y, textsize, textcolor, tinyfont;
...
// tiny font
static unsigned char tiny_font[] = {
...
void LCDInit()
{
        // LCDInit(3, 4, 2, 1, 0, 60);
        LCDInit(4, 2, 0, 1, 16, 60);
}
...
void LCDwrite(uint8_t c)
{
	if (c == '\n')
	{
		if (tinyfont) cursor_y += textsize*6;
		else cursor_y += textsize*8;
		cursor_x = 0;
	}
	else if (c == '\r')
	{
